 ...
 * (c) 2014 Audioniek: rewritten for Etek ET16315 / Princeton PT6315
 *
...
2. Data setting command: 0b01XXTAnn
 ...
 A: 0=Auto display addres increment
    1=Fixed address
 nn  Mode
 00  Write display data (three bytes / digit)
 01  Write LED port (next byte written controls LEDs: bit=0 is LED on)
...
4. Display control command: 0b10XXDbbb
 D: 0=Display off
    1=Display on
...
#define ET16315_TEST_MODE      0b00001000
#define ET16315_AUTO_ADDR_INC  0b00000100
#define ET16315_CMD_WRITE_DATA 0b00000000
#define ET16315_CMD_SET_LED    0b00000001
#define ET16315_CMD_READ_KEY   0b00000010
#define ET16315_CMD_DONTCARE   0b00000011

#define ET16315_CMD2_DATA_SET(test_mode, auto_address_increment, command) \
		(0x40 | \
		(test_mode ? ET16315_TEST_MODE : 0x0) | \
		(auto_address_increment ? 0x0 : ET16315_AUTO_ADDR_INC) | \
		(command & 0x3))
